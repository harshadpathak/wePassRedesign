      ...
      <div class="flex items-end justify-between">
        <div class="space-y-1">
          <nav class="flex items-center gap-2 text-label-sm text-outline mb-1">
            ...
            <span class="material-symbols-outlined text-[14px]">chevron_right</span>
            <span class="text-gray-500 font-normal">Create Company</span>
          </nav>
          <h2 class="font-display tracking-tight text-headline-lg font-bold">Create Company</h2>
        </div>
        <a href="company.php"
      ...
      <!-- Information Banner -->
        <div class="bg-white border border-outline-variant rounded-2xl p-6 flex flex-col gap-4">
            <div class="flex gap-6 items-start">
                ...
                <div class="flex-1">
                    <h3 class="text-headline-md font-bold text-on-surface tracking-tight">Create a New Company Account</h3>
                    <p class="text-body-md text-secondary leading-relaxed text-gray-400">Directly create a fully configured company account with login credentials. The company user will be immediately active and can log in right away without any email verification or invitation process.</p>
                    <div class="bg-primary/5 rounded-2xl p-3 flex flex-wrap items-center gap-3 mt-4">
                        ...
                        <div
                            ...
                            <span class="text-body-md font-bold text-gray-600">Fill Company Details</span>
                        </div>
                        <!-- Step 2 -->
                        <div
                            class="flex items-center gap-2.5 bg-white rounded-full pl-2.5 pr-5 py-2 shadow-sm border border-outline-variant/40 transition-transform">
                            <span class="material-symbols-outlined text-emerald-500 text-[22px]"
                                style="font-variation-settings: 'FILL' 1;">check_circle</span>
                            <span class="text-body-md font-bold text-gray-600">Set Login Password</span>
                        </div>
                        <!-- Step 3 -->
                        <div
                            class="flex items-center gap-2.5 bg-white rounded-full pl-2.5 pr-5 py-2 shadow-sm border border-outline-variant/40 transition-transform">
                            <span class="material-symbols-outlined text-emerald-500 text-[22px]"
                                style="font-variation-settings: 'FILL' 1;">check_circle</span>
                            <span class="text-body-md font-bold text-gray-600">Account Active Instantly</span>
                        </div>
                    </div>
                </div>
            </div>
