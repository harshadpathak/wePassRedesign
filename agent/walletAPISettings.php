...
<body class="bg-background text-on-surface selection:bg-primary-container/20 selection:text-primary">
  ...
  <main class="ml-[300px] min-h-screen flex flex-col transition-all duration-300 ease-in-out">
            ...
            <div class="js-custom-panel hidden rounded-xl border border-outline-variant hover:border-primary/50 p-5 space-y-5">
              ...
              <div class="space-y-1.5">
                ...
                <label class="group flex items-center gap-3 w-full h-[46px] bg-surface-container-low border border-outline-variant rounded-lg px-3 cursor-pointer hover:border-primary hover:bg-primary/5 transition-all">
                  <input type="file" id="configFile" accept=".json,application/json" required class="js-file-upload sr-only" data-hint="JSON file · max 2 MB">
                  ...
                  <span class="min-w-0 leading-tight flex-1">
                    ...
                    <span class="js-file-hint block text-label-sm text-outline">JSON file · max 2 MB</span>
                  </span>
    ...
    <script>
      ...
      // File uploads (Config JSON / Apple / WWDR / Auth Key): show filename + clear, restore hint from data-hint
      (function () {
