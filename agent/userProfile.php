      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
        ...
        <div class="lg:col-span-2 space-y-6">
          ...
          <form class="bg-white rounded-2xl border border-outline-variant shadow-sm overflow-hidden">
              ...
              <div class="rounded-2xl border border-outline-variant p-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div class="space-y-2">
                    ...
                    <input type="text" value="<?= htmlspecialchars($user['role']) ?>" readonly disabled
                      class="w-full bg-surface-container-high/60 border-outline-variant placeholder:text-slate-400 rounded-lg py-3 px-4 text-body-md text-secondary cursor-not-allowed">
                  </div>
                  <div class="space-y-2">
            ...
            <div class="flex justify-end px-6 lg:px-8 py-5 border-t border-outline-variant/60">
              <button type="submit"
            ...
            <div class="p-6 lg:p-8 space-y-5">
              <div class="space-y-2 md:max-w-[calc(50%-0.625rem)]">
                ...
                <div class="relative">
                    ...
                    <button type="button" data-toggle-pw="cur-pw"
                ...
                <div class="space-y-2">
                  ...
                  <div class="relative">
                      <input type="password" id="new-pw" placeholder="Enter New Password"
                          class="w-full bg-surface-container-low border-outline-variant rounded-lg py-3 pr-4 text-body-md text-on-surface placeholder:text-slate-400 focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all">
                      <button type="button" data-toggle-pw="new-pw"
                          class="material-symbols-outlined text-[20px] text-outline absolute right-3.5 top-1/2 -translate-y-1/2 hover:text-on-surface transition-colors cursor-pointer">visibility</button>
                  </div>
                </div>
                <div class="space-y-2">
                  ...
                  <div class="relative">
                      <input type="password" id="conf-pw" placeholder="Confirm New Password"
                          class="w-full bg-surface-container-low border-outline-variant rounded-lg py-3 pr-4 text-body-md text-on-surface placeholder:text-slate-400 focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all">
                      <button type="button" data-toggle-pw="conf-pw"
                          class="material-symbols-outlined text-[20px] text-outline absolute right-3.5 top-1/2 -translate-y-1/2 hover:text-on-surface transition-colors cursor-pointer">visibility</button>
                  </div>
                </div>
              </div>
