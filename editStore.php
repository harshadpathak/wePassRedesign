    ...
    <section class="p-margin-desktop space-y-stack-lg pb-16">
      ...
      <div class="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        <div class="space-y-1">
          <nav class="flex items-center gap-2 text-label-sm text-outline mb-1">
            ...
            <span class="text-gray font-normal">Stores</span>
            <span class="material-symbols-outlined text-[14px]">chevron_right</span>
            <span class="text-gray-500 font-normal">Edit Store</span>
          </nav>
          <h2 class="font-display tracking-tight text-headline-lg font-bold">Edit Store</h2>
        </div>
        <a href="stores.php"
      ...
      <form class="space-y-stack-lg">
        ...
        <div class="bg-white rounded-2xl border border-outline-variant p-6 shadow-sm">
              ...
              <div class="flex flex-col flex-1 space-y-2">
                ...
                <div class="relative flex-1">
                  <textarea id="walletMsg" maxlength="120" required
                    ...
                    class="w-full h-full min-h-[120px] bg-surface-container-low border-outline-variant rounded-lg py-3 px-4 text-body-md text-on-surface placeholder:text-slate-400 focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all resize-none">You are near our Aatman Infotech store. Tap to view your pass.</textarea>
                  <span class="absolute bottom-3 right-3 text-label-sm text-outline pointer-events-none">
                    <span id="walletMsgCount">61</span> / 120
                  </span>
                </div>
              ...
              <div class="space-y-2">
                ...
                <label class="group flex items-center gap-3 w-full h-[46px] bg-surface-container-low border border-outline-variant rounded-lg px-3 cursor-pointer hover:border-primary hover:bg-primary/5 transition-all">
                  ...
                  <span class="w-7 h-7 rounded-lg bg-primary/10 text-primary flex items-center justify-center shrink-0 overflow-hidden">
                    <span id="storeImageIcon" class="hidden material-symbols-outlined text-[18px]">cloud_upload</span>
                    <img id="storeImagePreview" src="Aatman Logo.png" class="w-full h-full object-cover" alt="Store image preview">
                  </span>
                  <span class="min-w-0 leading-tight flex-1">
                    <span id="storeImageTitle" class="block text-label-md font-bold text-on-surface truncate">aatman-logo.png</span>
                    <span id="storeImageHint" class="block text-label-sm text-outline">Current image &mdash; click to replace</span>
                  </span>
                  <span role="button" id="storeImageClear" class="shrink-0 w-7 h-7 rounded-full text-outline hover:bg-rose-50 hover:text-rose-600 flex items-center justify-center transition-all">
          ...
          <div class="space-y-2">
            ...
            <div class="relative">
              ...
              <input type="text" placeholder="Search by address, store name, landmark, or place"
                value="701, Aatman Infotech, Wings Business Bay, Umiya Chowk, Rajkot, 360004"
          ...
          <div id="locStatus" class="flex items-center gap-1.5 text-emerald-600 font-bold text-label-md">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
            ...
            <div class="relative h-72 rounded-xl border border-outline-variant bg-surface-container-low/50 overflow-hidden flex items-center justify-center bg-[radial-gradient(circle_at_1px_1px,theme(colors.outline-variant)_1px,transparent_0)] [background-size:24px_24px] hover:border-primary/50 transition-colors">
              ...
              <div id="mapPin" class="flex flex-col items-center">
            ...
            <div class="h-72 rounded-xl border border-outline-variant bg-white p-5 overflow-hidden hover:border-primary/50 transition-colors">
              ...
              <!-- SELECTED state -->
              <div id="locSelected" class="h-full flex flex-col">
                <!-- Header -->
                <div class="flex items-start gap-3 pb-3 border-b border-outline-variant/50">
                  ...
                  <div class="min-w-0 flex-1">
                    ...
                    <h5 class="text-body-lg font-semibold text-on-surface leading-tight">701, Aatman Infotech, Wings Business Bay, Umiya Chowk, Rajkot, 360004</h5>
                  </div>
                  <a id="gmapsLink" href="https://www.google.com/maps?q=22.25797520,70.78807400" target="_blank" rel="noopener"
                ...
                <div class="grid grid-cols-2 gap-2.5 mt-3 flex-1">
                  ...
                  <div class="rounded-xl border border-outline-variant/60 bg-surface-container-low/30 p-3 flex flex-col justify-center min-w-0 hover:border-primary/50 hover:bg-white transition-colors">
                    ...
                    <p id="sourceVal" class="text-body-md font-semibold text-on-surface mt-1.5 truncate">Coordinates</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div class="space-y-2">
                  ...
                  <input type="text" id="advLat" readonly value="22.25797520"
                    class="w-full bg-surface-container-high/60 border-outline-variant/60 rounded-lg py-3 px-4 text-body-md text-gray-500 cursor-not-allowed">
                </div>
                <!-- Longitude -->
                <div class="space-y-2">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-5 gap-y-4">
              ...
              <div class="flex items-start gap-3 min-w-0">
                ...
                <div class="min-w-0">
                  ...
                  <p id="sumCoords" class="text-body-md font-semibold text-on-surface truncate">22.25797520, 70.78807400</p>
                </div>
              </div>
              <!-- Wallet Message -->
              <div class="flex items-start gap-3 min-w-0">
