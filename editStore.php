              ...
              <div class="flex flex-col flex-1 space-y-2">
                ...
                <div class="relative flex-1">
                  <textarea id="walletMsg" maxlength="120" required
                    ...
                    class="w-full h-full min-h-[120px] bg-surface-container-low border-outline-variant rounded-lg py-3 px-4 text-body-md text-on-surface placeholder:text-outline focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all resize-none">You are near our Aatman Infotech store. Tap to view your pass.</textarea>
