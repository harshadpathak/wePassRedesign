    ...
    <section class="p-margin-desktop space-y-stack-lg pb-16">
      ...
      <div class="flex items-end justify-between">
        <div class="space-y-1">
          <nav class="flex items-center gap-2 text-label-sm text-outline mb-1">
            ...
            <span class="material-symbols-outlined text-[14px]">chevron_right</span>
            <span class="text-gray-500 font-normal">Add Country</span>
          </nav>
          <h2 class="font-display tracking-tight text-headline-lg font-bold">Add Country</h2>
        </div>
      ...
      <form class="w-full bg-white rounded-2xl border border-outline-variant/70 shadow-sm">
            ...
            <div class="flex items-center gap-4 p-6 border-b border-outline-variant/50">
                ...
                <div>
                    <h3 class="text-headline-md font-bold text-on-surface tracking-tight">Add Country</h3>
                    <p class="text-body-md text-gray-400">Create a new country entry</p>
                </div>
            </div>
            ...
            <div class="p-6">
              <div class="space-y-2">
                 ...
                 <input type="text" id="country_name" name="country_name" placeholder="e.g. Greece" required autofocus
