...
<body class="bg-background text-on-surface selection:bg-primary-container/20 selection:text-primary">
  ...
  <main class="ml-[300px] min-h-screen flex flex-col transition-all duration-300 ease-in-out">
    ...
    <?php
      ...
      $records = [
        ['updated' => '15/06/2026 04:57:36', 'updatedAgo' => '1 week ago', 'generated' => '15/06/2026 04:57:36', 'generatedAgo' => '1 week ago', 'pid' => 'c96e3bb8b10ea42682d3b2d88195c12f', 'user' => 'Harsh',    'email' => 'harsh@wepass.io',   'installed' => ['apple' => 1],                'uninstalled' => null],
        ['updated' => '15/06/2026 04:57:36', 'updatedAgo' => '1 week ago', 'generated' => '15/06/2026 04:57:36', 'generatedAgo' => '1 week ago', 'pid' => 'c96e3bb8b10ea42682d3b2d88195c12f', 'user' => 'Harsh',    'email' => 'harsh@wepass.io',   'installed' => null,                          'uninstalled' => ['google' => 1]],
        ['updated' => '13/06/2026 06:45:57', 'updatedAgo' => '1 week ago', 'generated' => '13/06/2026 06:45:57', 'generatedAgo' => '1 week ago', 'pid' => '0ef89b17f04d2370d242764f461a6092', 'user' => 'John Doe', 'email' => 'example@gmail.com', 'installed' => ['apple' => 1, 'google' => 1], 'uninstalled' => null],
        ['updated' => '13/06/2026 06:45:57', 'updatedAgo' => '1 week ago', 'generated' => '13/06/2026 06:45:57', 'generatedAgo' => '1 week ago', 'pid' => '0ef89b17f04d2370d242764f461a6092', 'user' => 'John Doe', 'email' => 'example@gmail.com', 'installed' => null,                          'uninstalled' => ['apple' => 1, 'google' => 1]],
      ];

      // Render Apple / Google count pills for an install/uninstall cell.
      // $data = ['apple' => n, 'google' => n] (either key optional) or null.
      function wp_wallet_badges($data) {
        if (empty($data)) return '<span class="text-label-md text-on-surface-variant">-</span>';
        $apple  = '<svg viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5 text-on-surface"><path d="M16.365 1.43c0 1.14-.493 2.27-1.177 3.08-.744.9-1.99 1.57-2.987 1.57-.12 0-.23-.02-.3-.03-.01-.06-.04-.22-.04-.39 0-1.15.572-2.27 1.206-2.98.804-.94 2.142-1.64 3.248-1.68.03.13.05.28.05.43zm4.565 15.71c-.03.07-.463 1.58-1.518 3.12-.945 1.34-1.94 2.71-3.43 2.71-1.517 0-1.9-.88-3.63-.88-1.698 0-2.302.91-3.67.91-1.377 0-2.332-1.26-3.428-2.8-1.287-1.82-2.323-4.63-2.323-7.28 0-4.28 2.797-6.55 5.552-6.55 1.448 0 2.675.95 3.6.95.865 0 2.222-1.01 3.902-1.01.613 0 2.886.06 4.374 2.19-.13.09-2.383 1.37-2.383 4.19 0 3.26 2.854 4.42 2.955 4.45z"/></svg>';
        $google = '<svg viewBox="0 0 24 24" class="w-5 h-5"><rect x="2.5" y="2" width="19" height="20" rx="2.5" fill="#34A853"/><rect x="2.5" y="4" width="19" height="18" rx="2.5" fill="#FBBC05"/><rect x="2.5" y="6.5" width="19" height="15.5" rx="2.5" fill="#EA4335"/><path d="M2 12.2 C 5.5 10.2 8.5 13.8 12 14 C 15.5 14.2 18.5 10.5 22 10.8 L 22 19.5 Q 22 22 19.5 22 L 4.5 22 Q 2 22 2 19.5 Z" fill="#4285F4"/></svg>';
        $pill = function ($count, $glyph) {
        ...
        $out = '<span class="inline-flex items-center gap-2">';
        if (!empty($data['apple']))  $out .= $pill($data['apple'], $apple);
        if (!empty($data['google'])) $out .= $pill($data['google'], $google);
        return $out . '</span>';
      }
    ?>
              ...
              <table class="w-full text-left border-collapse min-w-[1000px]">
                ...
                <tbody class="divide-y divide-outline-variant/40">
                  ...
                  <tr class="group hover:bg-primary/5 transition-colors">
                    ...
                    <td class="px-5 py-4 align-middle whitespace-nowrap"><?= wp_wallet_badges($r['installed']) ?></td>
                    <td class="px-5 py-4 align-middle whitespace-nowrap"><?= wp_wallet_badges($r['uninstalled']) ?></td>
