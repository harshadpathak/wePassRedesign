...
<head>
  ...
  <title>WePass - Edit Campaign</title>
...
<body class="bg-background text-on-surface selection:bg-primary-container/20 selection:text-primary">
      ...
      <div class="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        <div class="space-y-1">
          <nav class="flex items-center gap-2 text-label-sm text-outline mb-1">
            ...
            <span class="material-symbols-outlined text-[14px]">chevron_right</span>
            <span class="text-on-surface font-semibold">Edit Campaign</span>
          </nav>
          <h2 class="font-display tracking-tight text-headline-lg font-bold">Edit Campaign</h2>
        </div>
  ...
  <script>
    ...
    (function () {
      ...
      // Pre-select stores already on this campaign (edit page)
      document.querySelectorAll('[data-store][data-name="Apple Store"]').forEach(function (row) {
        addStore(row.querySelector('[data-add]'));
      });
